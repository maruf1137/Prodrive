            ...
            <div className="row y-gap-30">
              <div className="col-lg-3 col-sm-6">
                <div className="px-30 text-center">
                  <h3 className="text-30 md:text-24 fw-700">North America</h3>

                  <div className="mt-20 md:mt-10">
                    1 Dundas St W Suite 2500 Toronto ON M5G 1Z3, Canada
                    <br />
                    <br />
                    1-800-453-6744 canada@tourz.com
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="px-30 text-center">
                  <h3 className="text-30 md:text-24 fw-700">Australia</h3>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="px-30 text-center">
                  <h3 className="text-30 md:text-24 fw-700">Europe</h3>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="px-30 text-center">
                  <h3 className="text-30 md:text-24 fw-700">Asia</h3>
